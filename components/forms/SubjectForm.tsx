...
const SubjectForm: React.FC<SubjectFormProps> = ({ subject, schools, onClose, onSave, initialSchoolId }) => {
  ...
  useEffect(() => {
    if (subject) {
      setFormData({
        ...
        setFormData({ name: '', schoolId: initialSchoolId });
    }
  }, [subject, initialSchoolId]);
